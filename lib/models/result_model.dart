...
class BLEInfo {
  ...
  static BLEInfo fromJson(Map<String, dynamic> json) {
    ...
    return BLEInfo(success: json["success"], message: "", bleInfoDatas: bleInfoDataList);
  }

  Map<String, dynamic> toJson() => {"success": success, "message": message, "bleInfoDatas": bleInfoDatas};
...
class BLEInfoData {
  ...
  static List<BLEInfoData> fromJsons(List<dynamic> jsons) {
    ...
    for (int i = 0; i < jsons.length; i++) {
      bleInfoDatas.add(BLEInfoData.fromJson(jsons[i]));
    }
