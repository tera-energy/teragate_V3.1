...
class BottomNavBar extends StatefulWidget {
  ...
  const BottomNavBar(
      {this.currentLocation, this.currentTime, this.function, Key? key})
      : super(key: key);
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    CustomText(
                      text: _textIncision(widget.currentLocation == "" ||
  ...
  Container _createIconByContainer({
    ...
    backgroundColor = icon == Icons.refresh
        ...
        : selectedIcon
            ...
            : Colors.white;
    color =
        selectedIcon ? Colors.white : const Color.fromARGB(255, 60, 95, 235);
