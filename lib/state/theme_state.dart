...
class _ThemeState extends State<ThemeMain> {
                                            ...
                                            Row(
                                              children: [
                                                Checkbox(
                                                    ...
                                                    onChanged: (value) {
                                                      setState(() {
                                                        _isCheckedBackground =
                                                            value!;
                                                      });
                                                      Env.CHECKED_BACKGOURND =
                                                          value!;
                                                    }),
                                                const CustomText(
                                                  text: "배경색 사용",
                                              ...
                                              child: Visibility(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: List.generate(
                                                      backgrounListItems.length,
                                                      (index) =>
                                                          initContainerByImageBox(
                                                              list:
                                                                  backgrounListItems,
                                                              index: index)),
                                                ),
  ...
  Container initContainerByImageBox({required int index, required list}) {
    return Container(
        ...
        height: 100,
        width: 50,
        decoration: list[index]["value"]
            ? BoxDecoration(
                border: Border.all(color: const Color(0xff26C145), width: 5))
            : null,
                      ...
                      image: list[index]["image"].toString().startsWith('/data')
                          ...
                          list[index]["image"].toString().startsWith('/private')
                              ? FileImage(File(list[index]["image"]),
                                  scale: 0.2)
                              : AssetImage("assets/${list[index]["image"]}.png")
                                  as ImageProvider,
                      fit: BoxFit.fill
